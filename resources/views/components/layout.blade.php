...
<html lang="en">
    <head>
        ...
        <title>Sound Bezumni</title>
    </head>
    <body class="mb-48">
        <nav class="flex justify-between items-center mb-4">
            <a href="/"><img width="150" height="100"  src="{{asset('images/logo.png')}}"  alt="" class="logo"/></a>
    ...
    >
        <p class="ml-2">Portfolio &copy; 2022, Arseniy Baryshnikov</p>
